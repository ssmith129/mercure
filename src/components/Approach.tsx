          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="aspect-[3/4] bg-gradient-to-br from-azure-mist to-whisper-grey rounded-xl overflow-hidden">
                  <img
                ...
                <div className="aspect-[4/3] bg-gradient-to-br from-jade-green/10 to-deep-teal/10 rounded-xl flex items-center justify-center">
                  <div className="text-center space-y-2">
                    <MapPin className="h-8 w-8 text-jade-green mx-auto" />
                    <p className="text-deep-teal font-open-sans font-semibold text-sm">In-Person Care</p>
                  </div>
                </div>
              </div>
              <div className="space-y-4 pt-8">
                <div className="aspect-[4/3] bg-gradient-to-br from-deep-teal/10 to-jade-green/10 rounded-xl flex items-center justify-center">
                  <div className="text-center space-y-2">
                    <Video className="h-8 w-8 text-deep-teal mx-auto" />
